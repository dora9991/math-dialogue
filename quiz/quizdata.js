    ...
    {no:"3", type:"input", lead:"y は x に反比例し、x=-4 のとき y=3 です。",
      subs:[
        {lb:"(1)", prompt:"y を x の式で表しましょう。", mode:"expr", a:"y=-12/x", ph:"y=...",
          select:["y=12/x","y=-12/x","y=-12x","y=x/-12","y=-4/x","わからない"]},
        {lb:"(2)", prompt:"x=6 のときの y の値を求めましょう。", mode:"num", a:-2, ph:"y=..."},
      ]},
  ],
    bonus:{ type:"multi", lead:"反比例 y=-5/(2x) のグラフ上にある点を、次のうちからすべて選びましょう。",
      points:[["A",1,-2.5],["B",-2,1.25],["C",5,-0.5],["D",1,2.5],["E",2,-5],["F",-1,-2.5]],
      correct:[0,1,2],
      sol:"y=-5/(2x) は xy=-5/2(=-2.5) となる点。A: 1×(-2.5)=-2.5 ○／B: (-2)×1.25=-2.5 ○／C: 5×(-0.5)=-2.5 ○／D: 1×2.5=2.5 ×（符号が逆）／E: 2×(-5)=-10 ×（比例 y=-2.5x と混同した値）／F: (-1)×(-2.5)=2.5 ×（符号が逆）。よって正解は A・B・C。" },
  },
