...
const CH = [
  ...
  { id:"M1-04-5", no:"4-5", name:"反比例", pages:"p.139–142", limit:600, qs:[
    ...
    bonus:{ type:"choice", lead:"反比例 y=-5/(2x) のグラフ上にある点は、次のうちどれでしょう。",
      choices:["(1, 2.5)","(2, -5)","(1, -2.5)","(-1, -2.5)"],
      subs:[{a:2}],
      sol:"y=-5/(2x) は xy=-5/2(=-2.5) となる点。(1, 2.5): 1×2.5=2.5 ×（符号が逆）／(2, -5): 2×(-5)=-10 ×（比例 y=-2.5x と混同した値）／(1, -2.5): 1×(-2.5)=-2.5 ○／(-1, -2.5): (-1)×(-2.5)=2.5 ×（符号が逆）。よって正解は (1, -2.5)。" },
  },
